...
namespace StartGame.PlayerData
{
    internal class DefensiveBanditAI : Player
    {
        ...
        public override void PlayTurn(MainGameWindow main, bool SingleTurn)
        {
            ...
            path.Start();
            DistanceGraphCreator campGraph = new DistanceGraphCreator(this, troop.Position.X, troop.Position.Y, map, true);
            ...
            while (actionPoints.Value > 0)
            {
                ...
                catch (Exception e)
                {
                    ...
                    EndTurn(main, SingleTurn, damageDealt, dodged);
                    return;
                }
                ...
                campGraph = new DistanceGraphCreator(this, troop.Position.X, troop.Position.Y, map, true);
        ...
        private void EndTurn(MainGameWindow main, bool SingleTurn, int damageDealt, int dodged)
        {
            if (SingleTurn)
            {
                if (damageDealt != 0)
